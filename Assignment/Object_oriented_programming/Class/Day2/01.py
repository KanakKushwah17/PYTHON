...
Task: Design a Python class named BankAccount and implement all the above methods using instance methods, class methods, 
and static methods appropriately.
'''
class Bankaccount():
    bank_name="ABC Bank"
    interest_rate=5
...
amt=int(input("Enter amiunt : "))

id2=int(input("Enter  id  2: "))
name2=input("Enter name 2 : ")
amt2=int(input("Enter amiunt 2 : "))
        
customer1 = Bankaccount(id,name,amt)
customer2 = Bankaccount(id2,name2,amt2)   